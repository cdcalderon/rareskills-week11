...
before(async () => {
  ...
  // Deploy the GatekeeperOne contract using Hardhat
...
it("solves the challenge", async function () {
  ...
  // Check if the entrant of the GatekeeperOne contract is set to the attacker's address
  expect(await challenge.entrant()).to.equal(attacker.address);
});
